            ...
            <tr>
                ...
                <td>
                    <ul class="sf_admin_td_actions">
                        ...
                        echo '<li class="sf_admin_action_edit">' . link_to(__('Edit', array(), 'sf_admin'), 'medico_particular_edit', $medico, array('onclick'=>"dijit.byId('dojotheme-maincontainer').set('href',this.href);return false;",'query_string'=>$extra_url_custom_id) ).'</li>';
