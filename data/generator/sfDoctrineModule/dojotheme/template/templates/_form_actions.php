<?php 
$aux_extra_url_custom_id = array_key_exists('extra_url_custom_id', $this->params) ? '\'query_string\'=>$extra_url_custom_id' : '';
$extra_url_custom_id = array_key_exists('extra_url_custom_id', $this->params) ? ' . \'?\' . $extra_url_custom_id' : '';
...
<?php elseif ('_list' == $name): ?>
  ...
  <?php echo $this->addCredentialCondition('[?php echo \'<li class="sf_admin_action_list">\' . link_to(__(\'' . $params['label'] . '\', array(), \'sf_admin\'), \'@\' . $helper->getUrlForAction(\'list\') ' . $extra_url_custom_id . ' , array(\'onclick\'=>"dijit.byId(\'' . $dojo_forajax_component_id . '\').set(\'href\',this.href);return false;") ).\'</li>\'  ?]', $params) ?>
