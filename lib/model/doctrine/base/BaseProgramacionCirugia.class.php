 ...
 * @method ProgramacionCirugia setFileInternacionId()         Sets the current record's "file_internacion_id" value
 ...
 * @method ProgramacionCirugia setFileInternacion()           Sets the current record's "FileInternacion" value
 * 
 * @package    hcps
 * @subpackage model
