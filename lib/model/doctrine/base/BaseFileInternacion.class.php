 ...
 * @method FileInternacion     setFileInternacion()          Sets the current record's "FileInternacion" collection
 * 
 * @package    hcps
 * @subpackage model
...
abstract class BaseFileInternacion extends sfDoctrineRecord
{
    ...
    public function setUp()
    {
        ...
        $this->hasMany('AutorizacionDiagnosticoTratamiento as FileInternacion', array(
             'local' => 'id',
             'foreign' => 'file_internacion_id'));
