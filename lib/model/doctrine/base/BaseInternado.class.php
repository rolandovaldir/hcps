 ...
 * @method Internado           setId()                      Sets the current record's "id" value
 ...
 * @method Internado           setCreatedAt()               Sets the current record's "created_at" value
 * @method Internado           setUpdatedAt()               Sets the current record's "updated_at" value
