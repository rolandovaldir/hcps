...
abstract class BaseOrdenMedicaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'nombre_medicamento_indicacion' => new sfWidgetFormFilterInput(array('with_empty' => false)),
      ...
      'fecha_terminacion'             => new sfWidgetFormFilterDate(array('from_date' => new sfWidgetFormDate(), 'to_date' => new sfWidgetFormDate(), 'with_empty' => false)),
