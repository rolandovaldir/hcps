...
/**
 * ProgramacionCirugias filter form base class.
 *
 * @package    hcps
 * @subpackage filter
 ...
 */
abstract class BaseProgramacionCirugiasFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('programacion_cirugias_filters[%s]');
