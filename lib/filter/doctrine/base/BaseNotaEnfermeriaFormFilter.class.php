...
/**
 * NotaEnfermeria filter form base class.
 *
 * @package    hcps
 * @subpackage filter
 ...
 */
abstract class BaseNotaEnfermeriaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('nota_enfermeria_filters[%s]');
