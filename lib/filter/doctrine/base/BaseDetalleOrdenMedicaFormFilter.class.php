...
/**
 * DetalleOrdenMedica filter form base class.
 *
 * @package    hcps
 * @subpackage filter
 ...
 */
abstract class BaseDetalleOrdenMedicaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'orden_medica_id'               => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('OrdenMedica'), 'add_empty' => true)),
      ...
      'fecha_inicio'                  => new sfWidgetFormFilterDate(array('from_date' => new myWidgetFormDojoDate(), 'to_date' => new myWidgetFormDojoDate())),
      'fecha_terminacion'             => new sfWidgetFormFilterDate(array('from_date' => new myWidgetFormDojoDate(), 'to_date' => new myWidgetFormDojoDate())),
    ...
    $this->setValidators(array(
      'orden_medica_id'               => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('OrdenMedica'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('detalle_orden_medica_filters[%s]');
