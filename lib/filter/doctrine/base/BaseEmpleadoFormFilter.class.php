...
abstract class BaseEmpleadoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'profesion'       => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'centro_salud_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Filial'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'centro_salud_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Filial'), 'column' => 'id')),
