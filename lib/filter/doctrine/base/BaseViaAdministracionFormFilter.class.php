...
/**
 * ViaAdministracion filter form base class.
 *
 * @package    hcps
 * @subpackage filter
 ...
 */
abstract class BaseViaAdministracionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('via_administracion_filters[%s]');
