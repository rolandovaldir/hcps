...
abstract class BaseSolicitudTransfusionSanguineaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'fecha_prog_quirurgica'     => new sfWidgetFormFilterDate(array('from_date' => new myWidgetFormDojoDate(), 'to_date' => new myWidgetFormDojoDate())),
      'hora_prog_quirurgica'      => new sfWidgetFormFilterInput(),
      'quirofano_prog_quirurgica' => new sfWidgetFormFilterInput(),
      'cantidad_requerida'        => new sfWidgetFormFilterInput(),
      'cantidad_requerida_unidad' => new sfWidgetFormFilterInput(),
      'observaciones'             => new sfWidgetFormFilterInput(),
      'fecha_solicitud'           => new sfWidgetFormFilterDate(array('from_date' => new myWidgetFormDojoDate(), 'to_date' => new myWidgetFormDojoDate())),
      'hora_solicitud'            => new sfWidgetFormFilterInput(),
      'medico_id'                 => new sfWidgetFormFilterInput(),
      'numero'                    => new sfWidgetFormFilterInput(),
      'fecha_recepcion_solicitud' => new sfWidgetFormFilterDate(array('from_date' => new myWidgetFormDojoDate(), 'to_date' => new myWidgetFormDojoDate())),
