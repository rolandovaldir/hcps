...
/**
 * NotaEvolucion filter form base class.
 *
 * @package    hcps
 * @subpackage filter
 ...
 */
abstract class BaseNotaEvolucionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('nota_evolucion_filters[%s]');
