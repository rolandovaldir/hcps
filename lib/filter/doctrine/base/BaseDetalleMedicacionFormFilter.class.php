...
abstract class BaseDetalleMedicacionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'solicitud_intercosultada_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('SolicitudInterconsulta'), 'add_empty' => true)),
      'medicacion_utilizada'        => new sfWidgetFormFilterInput(),
      'dosis'                       => new sfWidgetFormFilterInput(),
      'fecha_inicio'                => new sfWidgetFormFilterDate(array('from_date' => new myWidgetFormDojoDate(), 'to_date' => new myWidgetFormDojoDate(), 'filter_template' => '%date_range% %empty_checkbox% %empty_label%', 'template' => '<table class="onlyFormat"><tr><td>from</td><td>%from_date%</td><tr/><tr><td>to</td><td>%to_date%</td></tr></table>')),
    ...
    $this->setValidators(array(
      'solicitud_intercosultada_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('SolicitudInterconsulta'), 'column' => 'id')),
  ...
  public function getFields()
  {
    return array(
      'id'                          => 'Number',
      'solicitud_intercosultada_id' => 'ForeignKey',
