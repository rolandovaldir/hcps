...
/**
 * AutorizacionDiagnosticoTratamiento filter form.
 *
 * @package    hcps
 * @subpackage filter
 ...
 */
class AutorizacionDiagnosticoTratamientoFormFilter extends BaseAutorizacionDiagnosticoTratamientoFormFilter
{
