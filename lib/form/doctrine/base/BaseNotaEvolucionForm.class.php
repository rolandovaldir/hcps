...
/**
 * NotaEvolucion form base class.
 *
 * @method NotaEvolucion getObject() Returns the current form's model object
 *
 * @package    hcps
 * @subpackage form
 ...
 */
abstract class BaseNotaEvolucionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('nota_evolucion[%s]');
