...
abstract class BaseInternadoForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'categoria_id'            => new myWidgetFormDojoInteger(),
      ...
      'medico_consulta_id'      => new myWidgetFormDojoInteger(),
      'medico_referencia_id'    => new myWidgetFormDojoInteger(),
      'formulario_referencia'   => new sfWidgetFormTextarea(),
      'diagnostico'             => new sfWidgetFormTextarea(),
      'procedencia'             => new sfWidgetFormTextarea(),
      'medio_referencia'        => new sfWidgetFormTextarea(),
      ...
      'tratamientio'            => new sfWidgetFormTextarea(),
      'lugar_referencia_salida' => new sfWidgetFormTextarea(),
      'medio_referencia_salida' => new sfWidgetFormTextarea(),
      'motivo_refe_retorno'     => new sfWidgetFormTextarea(),
    ...
    $this->setValidators(array(
      ...
      'cama_id'                 => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Cama'), 'required' => false)),
      ...
      'altaFecha'               => new myValidatorDojoDate(),
