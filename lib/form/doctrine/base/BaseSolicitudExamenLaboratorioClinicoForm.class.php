...
abstract class BaseSolicitudExamenLaboratorioClinicoForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'otros_examenes'                       => new sfWidgetFormTextarea(),
      'diagnostico_presuntivo'               => new sfWidgetFormTextarea(),
    ...
    $this->setValidators(array(
      ...
      'material_enviado'                     => new sfValidatorString(array('max_length' => 100)),
      'otros_examenes'                       => new sfValidatorString(array('max_length' => 200, 'required' => false)),
      'diagnostico_presuntivo'               => new sfValidatorString(array('max_length' => 200)),
