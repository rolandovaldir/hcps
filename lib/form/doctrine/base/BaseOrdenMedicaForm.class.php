...
abstract class BaseOrdenMedicaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'nombre_medicamento_indicacion' => new sfValidatorString(array('max_length' => 150)),
      'dosis_intervalo'               => new sfValidatorString(array('max_length' => 150)),
      'fecha_inicio'                  => new sfValidatorDate(),
      'fecha_terminacion'             => new sfValidatorDate(),
