...
/**
 * ProgramacionCirugias form base class.
 *
 * @method ProgramacionCirugias getObject() Returns the current form's model object
 *
 * @package    hcps
 * @subpackage form
 ...
 */
abstract class BaseProgramacionCirugiasForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('programacion_cirugias[%s]');
